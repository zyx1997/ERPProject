<?php
    ...
    class ChengpinYishousController extends AppController
    {
        public  $paginate  =  [ 
			'limit'  =>  10, //每页显示条数
			'order'  =>  [ 
				'ChengpinDictionarys.id'  =>  'desc' //按自增ID倒序即创建时间，顺序asc
			] 
		];
		...
		public function view($mid)
        {
		    ...
		    $this->loadComponent('Paginator');
			$this->set('mid',$mid);
			$this->set('chengpinDictionarys', $this->paginate($this->ChengpinDictionarys->find('all', array('conditions'=>array('ChengpinDictionarys.mid'=>$mid, 'ChengpinDictionarys.orderid is NOT NULL')))));
        }

                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                <div class="box-body table-responsive">
                                    ...
                                    <table class="table table-bordered table-hover">
										...
										<?php }elseif($caigouList['shenheok']==1){ ?> 
											<td><span class="label label-success">已审批（<?php echo $caigouList['shenheren'] ?>）</span></td> 
										...
										<td>
											<?= $this->Html->link('详情查看', ['action' => 'see', $caigouList['l_id']]); ?>
											<?php if(($caigouList['isshenhe']==0) || ($caigouList['isshenhe']==1 && $caigouList['shenheok']!=1) || ($caigouList['isshenpi']==1 && $caigouList['shenpiok']!=1)){  
												echo $this->Html->link('修改', ['action' => 'modify', $caigouList['l_id']]);
												echo $this->Html->link(' 产品添加', ['action' => 'searchmid', $caigouList['l_id']]);
												echo $this->Form->postLink(
													' 删除',
													['action' => 'delete', $caigouList['id']],
													['confirm' => '确认删除?']);
											} ?>
										</td>
										</tr>
								...
								<div class="box-footer clearfix no-border">
									<a href="/projectERP/caigouLists/index" class="btn btn-warning"><i class="glyphicon glyphicon-backward"></i> 返回</a>
								</div>
                            </div><!-- /.box-->
                        </div>
                    </div>

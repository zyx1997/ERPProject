        ...
        <section class="content">
            <div class="row">
				<form method="post" action="/projectERP/caigouLists/addM/<?= $caigouList['l_id'] ?>/<?= $lailiaoInitial['m_id'] ?>" class="box box-primary" accept-charset="utf-8" enctype="multipart/form-data" style="width: 60%; margin: 0px auto;">
                    <div class="box-body">
                        <div class="box-body"  style="width:90%;margin: auto;" >
                            ...
                            <div class="form-group" >
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="quantity" name="target_quantity" type="text" class="form-control" />
                                </div><!-- /.input group -->
                            </div><!-- /.form group -->
                            <div class="form-group">
                                <label>产品单价:</label>
                                <div class="input-group">
                                    ...
                                    <input id="price" name="target_price" type="text" class="form-control" />
                                </div><!-- /.input group -->
                            </div><!-- /.form group -->
							<div class="form-group">
                                <label>产品总价:</label>
                                <div class="input-group">
                                    ...
                                    <input id="totalPrice" name="target_totalprice" onclick="getTotalPrice()" type="text" class="form-control" />
                                </div><!-- /.input group -->
                            </div><!-- /.form group -->
                        </div>
                    </div><!-- /.box-body -->

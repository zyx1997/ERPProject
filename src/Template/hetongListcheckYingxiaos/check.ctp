        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><a href="/projectERP/hetongListcheckYingxiaos/index"><i class="fa fa-dashboard"></i>合同评审</a></li>
                <li class="active">合同审核（营销中心）</li>
            </ol>
        </section>
        <section class="content">
            <div class="row">
				<form method="post" class="box box-primary" accept-charset="utf-8" enctype="multipart/form-data" action="/projectERP/hetongListcheckYingxiaos/check/<?= $hetongList['id']; ?>"  style="width: 95%; margin: 0px auto;">
                    <div class="box-body">
                        <div class="col-xs-12">
                            ...
                            <div class="form-group" style="text-align: center;margin-top: 40px;">
                                <div style="margin: 10px auto;">
                                    <label>
                                        <input style="margin: 3px;" type="radio" name="shenheok_yingxiao" value="1" class="minimal" checked="" /> 通过
                                    </label>
                                    <label>
                                        <input style="margin: 3px;" type="radio" name="shenheok_yingxiao" value="0" class="minimal" />  驳回
                                    </label>
                                </div>
                            </div>
							<div class="box-header">
							...
							<div class="box-body"  style="width:90%;margin: auto;text-align: center">
								<textarea name="shenhe_beizhu_yingxiao" style="width:90%;margin: auto;"></textarea>
							</div>
							<?php } ?>
                        </div>
                    </div><!-- /.box-body -->

                            ...
                            <div class="box">
                                ...
                                <div class="box-body table-responsive">
                                    ...
                                    <div class="search-form margin">
                                        <form method="post" action="/projectERP/lailiaoInitials/search" class="text-right">
                                ...
                                <div class="box-footer clearfix no-border">
                                    <a href="/projectERP/lailiaoInitials/add" class="btn btn-warning pull-left"><i class="fa fa-plus"></i> 新增</a>
                                </div>
                            </div><!-- /.box-->
                        </div>
                    </div>

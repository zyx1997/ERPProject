        ...
        <section class="content">
            <div class="row">
				<form method="post" class="box box-primary" accept-charset="utf-8" enctype="multipart/form-data" action="/projectERP/caigouListchecks/check/<?= $caigouList['l_id']; ?>"  style="width: 90%; margin: 0px auto;">
                    <div class="box-body">

                            ...
                            <div class="box">
                                ...
                                <div class="box-body table-responsive">
                                    ...
                                    <div class="search-form margin">
                                        <form method="post" action="/projectERP/chengpinInitials/search" class="text-right">
                                    ...
                                    <table class="table table-bordered table-hover">
										...
										<td>
											<?= $this->Html->link('管理', ['action' => 'addfirstlevel', $chengpinInitial->mid]) ?>
											<?= $this->Form->postLink(
												'删除',
												['action' => 'delete', $chengpinInitial->id],
												['confirm' => '确认删除?'])
											?>
										</td>
                                ...
                                <div class="box-footer clearfix no-border">
                                    <a href="/projectERP/chengpinInitials/add" class="btn btn-warning pull-left"><i class="fa fa-plus"></i> 新增</a>
                                </div>
                            </div><!-- /.box-->
                        </div>
                    </div>

                            ...
                            <div class="box">
                                ...
                                <div class="box-body table-responsive">
                                    ...
                                    <div class="search-form margin">
                                        <form method="post" action="/projectERP/chengpinZhuangxiangs/search" class="text-right">
                                            <div class="input-group">
                                                <div class="input-group-btn">
                                                    <div class="btn-group">
														<div>
															装箱单编号：<input type="text" name="oid" />
															出库单编号：<input type="text" name="name" />
															装箱单名称：<input type="text" name="hetongid" />
                                    ...
                                    <table class="table table-bordered table-hover">
										...
										<td>
											...
											<?= $this->Html->link('修改', ['action' => 'modify', $chengpinZhuangxiang->zid]) ?>
											<?= $this->Form->postLink(
												'删除',
												['action' => 'delete', $chengpinZhuangxiang->id],
												['confirm' => '确认删除?'])
											?>
											<?php } else{ echo $this->Html->link('查看', ['action' => 'modify', $chengpinZhuangxiang->zid]);
											} ?>
										</td>
										</tr>
										<?php endforeach; ?>
								...
								<div class="box-footer clearfix no-border">
                                    <a href="/projectERP/chengpinZhuangxiangs/addform" class="btn btn-warning pull-left"><i class="fa fa-plus"></i> 新增</a>
                                </div>
								<!-- 分页导航 -->
								<div>

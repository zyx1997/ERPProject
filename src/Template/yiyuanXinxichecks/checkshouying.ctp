<!-- Content Header (Page header) -->
       ...
       <section class="content">
            <div class="row">
                <form method="post" action="/projectERP/yiyuanXinxichecks/checkshouying/<?=$yiyuanXinxi->id ?>" class="box box-primary box-content" enctype="multipart/form-data" style="width: 60%; margin: 0px auto;">

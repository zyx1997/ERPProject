	...
	<aside class="left-side sidebar-offcanvas">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
				...
				<?php } ?>
				<?php if($userRole->roleid=="root"||$userRole->roleid=="shichangbujl"||$userRole->roleid=="xiaoshouzhuanyuan"||$userRole->roleid=="officeManager"||$userRole->roleid=="zhijianManager"||$userRole->roleid=="shengchanManager"||$userRole->roleid=="caigouManeger"||$userRole->roleid=="manager"){ ?>
				<li class="treeview active">
                    <a href="#">
                        <i class="fa fa-bar-chart-o"></i>
                        <span>合同评审</span>

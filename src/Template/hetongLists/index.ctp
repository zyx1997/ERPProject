                            ...
                            <div class="box">
                                ...
                                <div class="box-body table-responsive">
                                    ...
                                    <div class="search-form margin">
                                        <form method="post" action="/projectERP/hetongLists/search" class="text-right">
                                            <div class="input-group">
                                                <div class="input-group-btn">
                                                    <div class="btn-group">
														<div>
															评审对象：<input type="text" name="duixiang" />
															合同评审编号：<input type="text" name="h_id" />
															订货单位名称：<input type="text" name="dh_name" />
                                ...
                                <div class="box-footer clearfix no-border">
                                    <a href="/projectERP/hetongLists/searchdinghuo" class="btn btn-warning pull-left"><i class="fa fa-plus"></i> 新增合同评审</a>
                                </div>
                            </div><!-- /.box-->
                        </div>
                    </div>

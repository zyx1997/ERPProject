					...
					<div class="row">
							<div class="box-body">
								<div class="box-body"  style="width:90%;margin: auto;" >
									...
									<?php if( strstr($hetongList['pingshenbumen_target'],"1")!=false){ ?>
									<div class="box-header">
										<h3 class="box-title">营销中心</h3>
									</div>
									<?php if($hetongList->isshenhe_yingxiao==0){ ?>
										<span class="label label-warning">未审批</span>
									<?php } elseif($hetongList->shenheok_yingxiao==1){ ?> 
										<span class="label label-success">已审批（<?php echo $shenheren_yingxiao ?>）</span>
									<?php } elseif($hetongList->shenheok_yingxiao==0){ ?> 
										<span class="label label-danger">已驳回（<?php echo $shenheren_yingxiao ?>）</span>
									<?php } ?>
									<div class="box-body">
										<p></p>
										<p>审核备注: <?= $hetongList->shenhe_beizhu_yingxiao ?></p>
									</div>
									<?php } ?>
									...
									<?php if( strstr($hetongList['pingshenbumen_target'],"3")!=false){ ?>
									<div class="box-header">
										<h3 class="box-title">质检部</h3>
									</div>
									<?php if($hetongList->isshenhe_zhijian==0){ ?>
										<span class="label label-warning">未审批</span>
									<?php } elseif($hetongList->shenheok_zhijian==1){ ?> 
										<span class="label label-success">已审批（<?php echo $shenheren_zhijian ?>）</span>
									<?php } elseif($hetongList->shenheok_zhijian==0){ ?> 
										<span class="label label-danger">已驳回（<?php echo $shenheren_zhijian ?>）</span>
									<?php } ?>
									<div class="box-body">
										<p></p>
										<p>审核备注: <?= $hetongList->shenhe_beizhu_zhijian ?></p>
									</div>
									<?php } ?>
									
									<?php if( strstr($hetongList['pingshenbumen_target'],"4")!=false){ ?>
									<div class="box-header">
										<h3 class="box-title">生产部</h3>
									</div>
									<?php if($hetongList->isshenhe_shengchan==0){ ?>
										<span class="label label-warning">未审批</span>
									<?php } elseif($hetongList->shenheok_shengchan==1){ ?> 
										<span class="label label-success">已审批（<?php echo $shenheren_shengchan ?>）</span>
									<?php } elseif($hetongList->shenheok_shengchan==0){ ?> 
										<span class="label label-danger">已驳回（<?php echo $shenheren_shengchan ?>）</span>
									<?php } ?>
									<div class="box-body">
										<p></p>
										<p>审核备注: <?= $hetongList->shenhe_beizhu_shengchan ?></p>
									</div>
									<?php } ?>
									
									<?php if( strstr($hetongList['pingshenbumen_target'],"5")!=false){ ?>
									<div class="box-header">
										<h3 class="box-title">采购部</h3>
									</div>
									<?php if($hetongList->isshenhe_caigou==0){ ?>
										<span class="label label-warning">未审批</span>
									<?php } elseif($hetongList->shenheok_caigou==1){ ?> 
										<span class="label label-success">已审批（<?php echo $shenheren_caigou ?>）</span>
									<?php } elseif($hetongList->shenheok_caigou==0){ ?> 
										<span class="label label-danger">已驳回（<?php echo $shenheren_caigou ?>）</span>
									<?php } ?>
									<div class="box-body">
										<p></p>
										<p>审核备注: <?= $hetongList->shenhe_beizhu_caigou ?></p>
									</div>
									<?php } ?>
									
									<?php if( strstr($hetongList['pingshenbumen_target'],"6")!=false){ ?>
									<div class="box-header">
										<h3 class="box-title">总经理</h3>
									</div>
									<?php if($hetongList->isshenhe_manager==0){ ?>
										<span class="label label-warning">未审批</span>
									<?php } elseif($hetongList->shenheok_manager==1){ ?> 
										<span class="label label-success">已审批（<?php echo $shenheren_manager ?>）</span>
									<?php } elseif($hetongList->shenheok_manager==0){ ?> 
										<span class="label label-danger">已驳回（<?php echo $shenheren_manager ?>）</span>
									<?php } ?>
									<div class="box-body">
										<p></p>
										<p>审核备注: <?= $hetongList->shenhe_beizhu_manager ?></p>
									</div>
									<?php } ?>
									<div class="box-footer clearfix no-border">
										<a href="/projectERP/hetongLists/index" class="btn btn-warning pull-right"><i class="glyphicon glyphicon-backward"></i> 返回</a>
									</div>
								</div><!-- /.box-body-->

                        ...
                        <div class="col-xs-12">
                            <div class="box">
									...
									<table class="table table-bordered table-hover" style="margin-bottom: 30px;">
										...
										<tr>
											...
											<?php } else{ ?> 
												<td></td>
											<?php } ?>
											<td><?php if( $hetongList->istijiao==0 || ( $hetongList->isshenhe==2 && $hetongList->pingshenbumen_diss != NULL ) ){ ?>
											<a href="/projectERP/hetongLists/modify/<?=$hetongList->id ?>" class="label label-primary btn-sm" style="color:white;"><i class="fa fa-edit"></i> 修改合同评审</a>
											<?php } ?>
											</td>
										</tr>
										</tfoot>
								...
								<div class="box-header">
                                    <h3 class="box-title">
									配套产品清单
									<a href="/projectERP/hetongLists/searchpeitao/<?= $hetongList['id'] ?>" class="btn btn-primary btn-sm" style="margin-left:10px;color:white;"><i class="fa fa-plus"></i> 添加配套产品</a>
									</h3>
                                </div><!-- /.box-header -->
                                <div class="table-responsive" style="width: 98%; margin: 10px auto;">
									<!-- 分页下拉框 -->
										...
										<div class="box box-primary">
											<div class="box-header" data-widget="collapse" data-toggle="tooltip">
												...
												<div class="box-tools pull-right">
													...
													<a href="/projectERP/hetongLists/deletePeitao/<?= $hetongListAll['id'] ?>" onclick="if(confirm('确定删除吗?')==false)return false;" title="删除" class="btn btn-primary btn-sm" style="color:white;" >
								...
								<div class="clearfix no-border"  style="margin-left: 40%;">
									<?php if( $hetongList->isshenhe==0 || ( $hetongList->isshenhe==2 && $hetongList->pingshenbumen_diss != NULL) ){  ?>
									...
									<a href="/projectERP/hetongLists/tijiaoshenhe/<?= $hetongList['id'] ?>" class="btn btn-success" style="margin-left:20px;text-align:center"><i class="fa fa-check"></i> 提交审核</a>
									<?php } ?>
								</div>
                            </div><!-- /.box-->
                        </div>

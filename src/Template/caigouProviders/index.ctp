                            ...
                            <div class="box">
                                ...
                                <div class="box-body table-responsive">
                                    ...
                                    <div class="search-form margin">
                                        <form method="post" action="/projectERP/caigouProviders/search" class="text-right">
                                ...
                                <div class="box-footer clearfix no-border">
                                    <a href="/projectERP/caigouProviders/add" class="btn btn-warning pull-left"><i class="fa fa-plus"></i> 新增供应方</a>
                                </div>
                            </div><!-- /.box-->
                        </div>
                    </div>

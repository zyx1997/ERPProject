<!-- Content Header (Page header) -->
        ...
        <section class="content">
            <div class="row">
                <form method="post" action="/projectERP/jingxiaoXinxis/addpeitao/<?=$jxid ?>/<?=$ptid ?>" enctype="multipart/form-data"  class="box box-primary" style="width: 60%; margin: 0px auto;">
                        ...
                        <div id="item_info" class="col-xs-12">
							...
							<div class="form-group" style="display:flex; flex-direction:row; justify-content: space-between;margin-top:20px;">
								...
								<div class="controls" style="width:90%;">
									<input type="text" name="peitaojiage" class="form-control"/>
								</div>
							</div><!-- /.form group -->
                        </div>
                    </div><!-- /.box-body -->

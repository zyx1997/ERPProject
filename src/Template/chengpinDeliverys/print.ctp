        ...
        <section class="content">
            <div class="row">
                <form action="/projectERP/chengpinDeliverys/index" class="box box-primary box-content" style="width: 60%; margin: 0px auto;">
                    ...
                    <div class="box-body" style="width:90%;margin: auto;">
						...
						<div class="form-group" style="display:flex; flex-direction:row; justify-content: space-between;">
							...
							<div class="controls" style="width:90%;">
								<input type="text" value="S20190413001" readonly="readonly" class="form-control" required="required"  placeholder="请输入(必填)"/>
							</div>
                        </div><!-- /.form group -->
                        <!-- phone mask -->
                        <div class="form-group" style="display:flex; flex-direction:row; justify-content: space-between;">
                        ...
                        <div class="form-group" style="display:flex; flex-direction:row; justify-content: space-between;">
							...
							<div class="controls" style="width:90%;">
								<input type="text" value="项忆晴" class="form-control" required="required" placeholder="请输入(必填)" readonly="readonly" />
							</div>
                        </div><!-- /.form group -->
						<div class="form-group" style="display:flex; flex-direction:row; justify-content: space-between;">
                    ...
                    <div class="box-body"  style="width:90%;margin: auto;">
                        <div class="form-group" style="display:flex; flex-direction:row; justify-content: space-between;">
							...
							<div class="controls" style="width:90%;">
								<input type="text" class="form-control" placeholder="订单产品；订单型号" readonly="readonly" />
							</div>
                        </div><!-- /.form group -->
						<div class="form-group" style="display:flex; flex-direction:row; justify-content: space-between;">

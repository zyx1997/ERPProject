							...
							<div class="box-body">
								<div class="box-body"  style="width:90%;margin: auto;" >
									...
									<div class="box-header">
										...
										<span><?= $caigouList->shenpiren ?></span>
									</div>
									<div class="box-header">
										<h3 class="box-title">审批时间</h3>
										<span><?= $caigouList->shenpi_time ?></span>
									</div>
									<div class="box-header">
										<h3 class="box-title">审批备注</h3>
										<span><?= $caigouList->shenpi_beizhu ?></span>
									</div>
									
									<div class="box-footer clearfix no-border">
										<a href="/projectERP/caigouListshenpis/index" class="btn btn-warning pull-right"><i class="glyphicon glyphicon-backward"></i> 返回</a>
									</div>
								</div><!-- /.box-body-->

					...
					<form method="post" class="box box-primary" accept-charset="utf-8" enctype="multipart/form-data" action="/projectERP/xiaoshouListchecks/check/<?= $xiaoshouList['id']; ?>"  style="width: 100%; ">
						<div class="col-xs-12">
                            <div class="box">
								...
								<div class="clearfix no-border"  style="margin-left: 40%; margin-top:30px; padding-bottom: 50px;">
									...
									<input type="submit" value="提交" class="btn btn-primary btn-sm" style="margin-left: 20px;"></input>
								</div>
                            </div><!-- /.box-->
                        </div>
					</form><!-- /.box -->

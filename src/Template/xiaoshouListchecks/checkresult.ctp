                            ...
                            <div class="box">
								...
								<div class="table-responsive" style="width: 98%; margin: 10px auto;">
									...
									<div class="box-header">
										...
										<h3 class="box-title"><span style="margin-left:20px;">
										<?php if($xiaoshouList->istijiao==0){ ?>
										<span class="label label-default">未提交审核</span>
										<?php } elseif($xiaoshouList->isshenhe == 0){ ?>
										<span class="label label-warning">已提交审核</span>
									...
									<div class="box-header">
										...
										<h3 class="box-title"><span style="margin-left:20px;"><?= $shenheren ?></span></h3>
									</div>
									<div class="box-header">
										<h3 class="box-title">审核时间</h3>
										<h3 class="box-title"><span style="margin-left:20px;"><?= $xiaoshouList->shenhe_time->format('Y-m-d H:m:s') ?></span></h3>
									</div>
									<div class="box-header">
										<h3 class="box-title">审核备注</h3>
										<h3 class="box-title"><span style="margin-left:20px;"><?= $xiaoshouList->shenhe_beizhu ?></span></h3>
									</div>
									<?php } ?>
								</div><!-- /.box-body-->
								...
								<div class="clearfix no-border"  style="margin-left: 40%;">
									<a href="/projectERP/xiaoshouListchecks/index" class="btn btn-warning btn-sm " style="color:white;" ><i class="glyphicon glyphicon-backward"></i> 返回</a>
								</div>
                            </div><!-- /.box-->
                        </div>
                    </div>

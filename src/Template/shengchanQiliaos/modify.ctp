        ...
        <section class="content">
            <div class="row">
                <form action="/projectERP/shengchanQiliaos/index" class="box box-primary" style="width: 60%; margin: 0px auto;">
                    ...
                    <table class="table table-bordered table-hover" style="width: 90%;margin: auto;">
                        ...
                        <tr>
                            <th>计划生产开始时间</th>
                            <th><input type="text" class="datepicker" style="border:none;" value="2019-03-05"  placeholder="请输入..."></th>
                            <th>实际生产开始时间</th>
                            <th><input type="text" class="datepicker" style="border:none;" value="2019-03-08" placeholder="请输入..."/></th>
                        </tr>
                        <tr>
                            <th>计划生产数量</th>
                            <th><input style="border:none;" value="150"/></th>
                            <th>实际产出数量</th>
                            <th><input style="border:none;" value="160"/></th>
                        </tr>
                        </thead>
                    </table><!-- /.table -->
                    <div class="box-header">
                        <h3 class="box-title">齐套-物料清单</h3>
                    </div>
                    <div class="box-body"  style="width:90%;margin: auto;text-align: center">
                        <table class="table table-bordered table-hover" width="">
                            ...
                            <tr>
                                ...
                                <th><input style="border:none;" value="XA001"/></th>
                                <th><input style="border:none;" value="80"/></th>
                                <th></th>
                            </tr>
                            </thead>
                        </table><!-- /.table -->

        ...
        <section class="content">
            <div class="row">
				<form method="post" class="box box-primary" accept-charset="utf-8" enctype="multipart/form-data" action="/projectERP/shengchanQiliaos/duanque/<?= $shengchanQiliaoSecond['id']; ?>/<?= $lailiaoInitial['m_id']; ?>"  style="width: 60%; margin: 0px auto;">

            ...
            <div class="row">
                <div class="box box-primary" style="width: 60%; margin: 0px auto;">
                    ...
                    <div class="box-body"  style="width:90%;margin: auto;text-align: center">
						...
						<a href="/projectERP/jingxiaoXinxichecks/check/<?=$jingxiaoXinxi->id ?>" class="btn btn-primary btn-sm" style="margin: 0px auto;">返回</a>
						<?php }else{ ?>
						<a href="/projectERP/jingxiaoXinxichecks/view/<?=$jingxiaoXinxi->id ?>" class="btn btn-primary btn-sm" style="margin: 0px auto;">返回</a>
						<?php } ?>
                    </div>
                </div><!-- /.box -->
            </div>

					...
					<div class="row">
							<div class="box-body">
								<div class="box-body"  style="width:90%;margin: auto;" >
									...
									<div class="box-header" style="margin-top:60px">
										<h3 class="box-title">审批结果</h3>
										<?php if($caigouProvider->shenpiok==1){ ?> 
										<span class="label label-success">已审批</span>
										<?php } else { ?> 
										<span class="label label-danger">已驳回</span>
										<?php } ?>
									...
									<div class="box-header">
										<h3 class="box-title">审批人</h3>
										<span><?= $caigouProvider->shenpiren ?></span>
									</div>
									<div class="box-header">
										<h3 class="box-title">审批时间</h3>
										<span><?= $caigouProvider->shenpi_time ?></span>
									</div>
									<div class="box-header">
										<h3 class="box-title">审批备注</h3>
										<span><?= $caigouProvider->shenpi_beizhu ?></span>
									</div>
									<div class="box-footer clearfix no-border">
										<a href="/projectERP/caigouProvidershenpis/index" class="btn btn-warning pull-right"><i class="glyphicon glyphicon-backward"></i> 返回</a>
									</div>
								</div><!-- /.box-body-->
                            </div><!-- /.box-->
                    </div>
